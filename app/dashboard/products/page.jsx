...
const AddProduct = () => {
  ...
  // product add krne ke liye button dia hai usi ko hide and show kia hai 
  ...
  //key features
  const options = ["pay_over_time", "rx_required", "light_weight", "2_years_warranty", "free_shipping"];
  ...
  //product upload
  const [isUploadConfirmModalOpen, setIsUploadConfirmModalOpen] = useState(false);
            ...
            <form>
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {/* Product Detailed Description */}
                  <div className="mb-4">
                    <label className="block text-gray-600 mb-2">Product Detailed Description</label>
                      ...
                      <div className="max-w-7xl mx-auto bg-white p-8 rounded-md shadow">
                        {keyValuePairs.map((pair, index) => (
                          <div key={index} className="grid grid-cols-2 gap-4 mb-4">
                            {/* Key Text Area */}
                            <div>
                              <label className="block text-gray-600 mb-2">Key Point</label>
                              <textarea
                            ...
                            {/* Value Text Area */}
                            <div>
                              <label className="block text-gray-600 mb-2">Feature</label>
                              <textarea
                ...
                <div>
                  {/* Product Heighlights */}
                  <div className="mb-4">
                    <label className="block text-gray-600 mb-2">Product Highlights</label>
                    <div className="p-6 bg-gray-100 ">
                      <div className="max-w-7xl mx-auto bg-white p-8 rounded-md shadow">
                        {highlightsList.map((highlight, index) => (
                          <div key={index} className="mb-4">
                            ...
                            <textarea
                              ...
                              value={highlight}
                              onChange={(e) => updateHighlightText(index, e.target.value)}
                              className="w-full border border-gray-300 rounded px-4 py-2"
                              rows="2"
                            />
                            {index > 0 && (
                  ...
                  {/* Price Details */}
                  <div className="mb-4">
                    <label className="block text-gray-600 mb-2">Price Details</label>
                    <div className="flex space-x-4">
                      {/* Actual Price */}
                      <div className="flex-1">
                        <label className="block text-gray-600 mb-2">Actual Price</label>
                        <input
                      ...
                      {/* Dealer Price */}
                      <div className="flex-1">
                        <label className="block text-gray-600 mb-2">Dealer Price</label>
                        <input
                          type="text" // Use text to completely disable arrows
                  ...
                  {/* Product Status */}
                  <div className="mb-4">
                    <label className="block text-gray-600 mb-2">Product Status</label>
                    <div>
                  ...
                  <div className="mb-4">
                    ...
                    {images.length < 6 && (
                      <p className="text-sm text-red-500 mt-2">
                        You need at least 6 images. Currently {images.length} uploaded.
                      </p>
                    )}
                  </div>
                  {/* Stock quantity */}
                  ...
                  <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white p-6 rounded shadow-lg w-1/3">
                      ...
                      <p className="text-gray-600 mb-6">
                        Please make sure that every filled information is correct. Once it
                        is uploaded to the database, it's not that easy to manipulate the
                        data of all the fields again. So make sure about this.
                      </p>
